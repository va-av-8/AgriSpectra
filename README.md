...
| Компания / Продукт         | Мобильная диагностика | Спутниковые данные | Определение стадии роста | Обнаружение повреждений | Прогноз урожайности | Технологии                        | Ограничения                                                   |
|----------------------------|------------------------|---------------------|----------------------------|--------------------------|----------------------|------------------------------------|----------------------------------------------------------------|
| Plantix                    | Да                     | Нет                 | Нет                        | Да                       | Нет                   | CNN, мобильное приложение         | Нет прогноза, нет спутниковых данных, завязка на продажу агрохимии      |
| PlantVillage Nuru         | Да                     | Частично            | Ограничено                 | Да                       | Частично              | CNN, NLP, спутники                 | Не коммерческое, ограничено количество культур, нет предсказаний урожая     |
| Agrio                     | Да                     | Да                  | Нет                        | Да                       | Нет                   | CNN, NDVI, погодные модели         | Нет прогноза урожайности, зависимость от плотности данных      |
| Taranis                   | Нет (только дроны)     | Да                  | Нет                        | Да                       | Нет                   | Дроны, сверхвысокое разрешение     | Дорого, недоступно малым хозяйствам                            |
| OneSoil                   | Нет                    | Да                  | Частично (по NDVI)         | Частично                 | Нет                   | Sentinel-2, ML                     | Нет фотоанализа, нет прогноза урожайности                      |
| EOS Crop Monitoring       | Нет                    | Да                  | Да                         | Частично (по NDVI)       | Да                    | ML, спутники, WOFOST               | Не работает с фото, B2B-фокус, короткий горизонт прогноза         |
| SatSure                   | Нет                    | Да                  | Частично                   | Частично                 | Да                    | Big Data, TAMSAT, AI               | B2B-фокус, нет мобильного интерфейса для фермеров              |
| Climate FieldView         | Нет                    | Да                  | Частично                   | Частично                 | Частично              | IoT, спутники, Big Data            | Требует оборудование, нет ИИ-диагностики, дорогой              |
| Farmers Edge              | Нет                    | Да                  | Нет                        | Частично                 | Да                    | IoT, ML, спутники                  | Требует сенсоры, нет анализа фото, ограничен по культурам      |
| Descartes Labs            | Нет                    | Да                  | Нет                        | Нет                      | Да                    | Petabyte-scale AI                  | Только на макроуровне, не пригоден для управления полем        |
