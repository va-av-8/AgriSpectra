...
| Компания / Продукт         | Мобильная диагностика | Спутниковые данные | Определение стадии роста | Обнаружение повреждений | Прогноз урожайности | Ограничения                                                   |
|----------------------------|------------------------|---------------------|----------------------------|--------------------------|----------------------|----------------------------------------------------------------|
| Plantix                    | Да                     | Нет                 | Нет                        | Да                       | Нет                   | Нет прогноза, нет спутников, завязка на продажу агрохимии      |
| PlantVillage Nuru         | Да                     | Частично            | Ограничено                 | Да                       | Частично              | Не коммерческое, ограничено культурами, зависит от доноров     |
| Agrio                     | Да                     | Да                  | Нет                        | Да                       | Нет                   | Нет прогноза урожайности, зависимость от плотности данных      |
| Taranis                   | Нет (только дроны)     | Да                  | Нет                        | Да                       | Нет                   | Дорого, недоступно малым хозяйствам                            |
| OneSoil                   | Нет                    | Да                  | Частично (по NDVI)         | Частично                 | Нет                   | Нет фотоанализа, нет прогноза урожайности                      |
| EOS Crop Monitoring       | Нет                    | Да                  | Да                         | Частично (по NDVI)       | Да                    | B2B-фокус, не работает с фото, короткий горизонт прогноза                 |
| SatSure                   | Нет                    | Да                  | Частично                   | Частично                 | Да                    | B2B-фокус, нет мобильного интерфейса для фермеров              |
| Climate FieldView         | Нет                    | Да                  | Частично                   | Частично                 | Частично              | Требует оборудование, нет ИИ-диагностики, дорогой              |
| Farmers Edge              | Нет                    | Да                  | Нет                        | Частично                 | Да                    | Требует сенсоры, нет анализа фото, ограничен по культурам      |
| Descartes Labs            | Нет                    | Да                  | Нет                        | Нет                      | Да                    | Только на макроуровне, не пригоден для управления полем        |
